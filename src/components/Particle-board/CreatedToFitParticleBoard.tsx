...
const categories = [
    {id: 1, category: "Wall Paneling using Particle board", image: `/assets/particle-board/CreatedToFit/1.png`},
    {id: 2, category: "Luxury Cabinets Particle board", image: `/assets/particle-board/CreatedToFit/2.png`},
    {id: 3, category: "Luxury Counter tops using Particle board", image: `/assets/particle-board/CreatedToFit/3.png`},
    {id: 4, category: "Interior Using Particle Board", image: `/assets/particle-board/CreatedToFit/4.png`},
]

const CreatedToFitParticleBoard = () => {
    return (
        <>
            <div
...
export default CreatedToFitParticleBoard;
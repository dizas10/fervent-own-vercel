...
const categories = [
    {id: 1, category: "High-Quality MDF", image: `/assets/HLP/CreatedToFitMDF/1.png`},
    {id: 2, category: "MDF Wood Style", image: `/assets/HLP/CreatedToFitMDF/2.png`},
    {id: 3, category: "MDF Covering", image: `/assets/HLP/CreatedToFitMDF/3.png`},
    {id: 4, category: "Engineered Wood HDF Flooring", image: `/assets/HLP/CreatedToFitMDF/4.png`},
]

const CreatedToFitMDF = () => {
    return (
        <>
            <div
...
export default CreatedToFitMDF;